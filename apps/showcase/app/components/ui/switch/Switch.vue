...
<template>
  <SwitchRoot v-slot="slotProps" v-bind="forwarded" data-slot="switch" :class="cn('inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border border-[var(--ink)] bg-[var(--paper-deep)] p-0.5 outline-none transition-colors focus-visible:ring-3 focus-visible:ring-[var(--accent)] data-[state=checked]:bg-[var(--accent)] disabled:cursor-not-allowed disabled:opacity-45', props.class)">
