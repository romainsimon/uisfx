...
export const CUES = [
  ...
  { name: 'focus', label: 'Focus', category: 'input', description: 'A control becomes ready for keyboard or text input.', duration: 0.23, baseMidi: 74, notes: [{ at: 0, semitone: -5, length: 0.17, glide: 1 }, { at: 0, semitone: 2, length: 0.17, gain: 0.26 }], noise: 0.015, defaultVolume: 0.12 },
  ...
  { name: 'deselect', label: 'Deselect', category: 'selection', description: 'An item leaves the active set.', duration: 0.25, baseMidi: 70, notes: [{ at: 0, semitone: 4, length: 0.09 }, { at: 0.075, semitone: -2, length: 0.15 }], defaultVolume: 0.17 },
  { name: 'toggle-on', label: 'Toggle on', category: 'selection', description: 'A binary setting becomes active.', duration: 0.3, baseMidi: 67, notes: [{ at: 0, semitone: -3, length: 0.065, glide: -1 }, { at: 0.065, semitone: 9, length: 0.2 }], transient: 0.3, defaultVolume: 0.2 },
  { name: 'toggle-off', label: 'Toggle off', category: 'selection', description: 'A binary setting becomes inactive.', duration: 0.29, baseMidi: 67, notes: [{ at: 0, semitone: 9, length: 0.065 }, { at: 0.07, semitone: -3, length: 0.18, glide: -1 }], transient: 0.28, defaultVolume: 0.18 },
  { name: 'check', label: 'Check', category: 'selection', description: 'A checkbox or task enters its completed state.', duration: 0.29, baseMidi: 71, notes: [{ at: 0, semitone: -5, length: 0.075 }, { at: 0.07, semitone: 9, length: 0.17 }], transient: 0.24, defaultVolume: 0.17 },
  { name: 'uncheck', label: 'Uncheck', category: 'selection', description: 'A checkbox or task returns to its incomplete state.', duration: 0.27, baseMidi: 71, notes: [{ at: 0, semitone: 9, length: 0.07 }, { at: 0.065, semitone: -5, length: 0.15 }], transient: 0.22, defaultVolume: 0.15 },
  ...
  { name: 'cancel', label: 'Cancel', category: 'editing', description: 'A pending action is abandoned without applying.', duration: 0.34, baseMidi: 64, notes: [{ at: 0, semitone: 3, length: 0.11 }, { at: 0.08, semitone: -3, length: 0.2, glide: -2 }], noise: 0.05, defaultVolume: 0.17 },
  { name: 'undo', label: 'Undo', category: 'editing', description: 'The most recent change is reversed.', duration: 0.44, baseMidi: 67, notes: [{ at: 0, semitone: 9, length: 0.16, glide: -3 }, { at: 0.15, semitone: 4, length: 0.14 }, { at: 0.27, semitone: -2, length: 0.13, gain: 0.62 }], panFrom: 0.45, panTo: -0.45, defaultVolume: 0.18 },
  { name: 'redo', label: 'Redo', category: 'editing', description: 'A reversed change is applied again.', duration: 0.44, baseMidi: 67, notes: [{ at: 0, semitone: -2, length: 0.13, gain: 0.62 }, { at: 0.12, semitone: 4, length: 0.14 }, { at: 0.25, semitone: 9, length: 0.16, glide: 2 }], panFrom: -0.45, panTo: 0.45, defaultVolume: 0.18 },
  ...
  { name: 'paste', label: 'Paste', category: 'editing', description: 'Clipboard content is inserted into the current context.', duration: 0.36, baseMidi: 67, notes: [{ at: 0, semitone: 12, length: 0.08, gain: 0.3 }, { at: 0.065, semitone: 0, length: 0.19 }, { at: 0.17, semitone: 3, length: 0.14, gain: 0.42 }], transient: 0.22, defaultVolume: 0.17 },

  { name: 'open', label: 'Open', category: 'navigation', description: 'A menu, sheet, panel, or detail view appears.', duration: 0.37, baseMidi: 64, notes: [{ at: 0, semitone: -2, length: 0.28, glide: 9 }, { at: 0.18, semitone: 12, length: 0.11, gain: 0.3 }], noise: 0.05, defaultVolume: 0.18 },
  { name: 'close', label: 'Close', category: 'navigation', description: 'A menu, sheet, panel, or detail view recedes.', duration: 0.34, baseMidi: 64, notes: [{ at: 0, semitone: 12, length: 0.1, gain: 0.34 }, { at: 0.055, semitone: 5, length: 0.24, glide: -8 }], noise: 0.04, defaultVolume: 0.17 },
  ...
  { name: 'forward', label: 'Forward', category: 'navigation', description: 'Navigation advances to the next place.', duration: 0.31, baseMidi: 66, notes: [{ at: 0, semitone: -5, length: 0.12, glide: 3, gain: 0.55 }, { at: 0.09, semitone: 4, length: 0.17 }], noise: 0.06, panFrom: -0.35, panTo: 0.55, defaultVolume: 0.17 },
  { name: 'expand', label: 'Expand', category: 'navigation', description: 'A collapsed region reveals more detail.', duration: 0.37, baseMidi: 64, notes: [{ at: 0, semitone: 0, length: 0.12 }, { at: 0.11, semitone: 4, length: 0.13 }, { at: 0.22, semitone: 9, length: 0.12, gain: 0.52 }], panFrom: 0, panTo: 0.35, defaultVolume: 0.16 },
  { name: 'collapse', label: 'Collapse', category: 'navigation', description: 'An expanded region returns to its compact state.', duration: 0.35, baseMidi: 64, notes: [{ at: 0, semitone: 9, length: 0.11, gain: 0.52 }, { at: 0.1, semitone: 4, length: 0.12 }, { at: 0.2, semitone: 0, length: 0.12 }], panFrom: 0.35, panTo: 0, defaultVolume: 0.15 },
  ...
  { name: 'drop', label: 'Drop', category: 'movement', description: 'A dragged object lands in a valid target.', duration: 0.3, baseMidi: 55, notes: [{ at: 0, semitone: 7, length: 0.1, gain: 0.4 }, { at: 0.045, semitone: 0, length: 0.17, glide: -5 }, { at: 0.12, semitone: -5, length: 0.13, gain: 0.38 }], noise: 0.18, transient: 0.6, defaultVolume: 0.22 },
  ...
  { name: 'swipe', label: 'Swipe', category: 'movement', description: 'A touch gesture moves content spatially.', duration: 0.38, baseMidi: 69, notes: [{ at: 0.02, semitone: -4, length: 0.29, glide: 8, gain: 0.28 }], noise: 0.38, transient: 0.08, panFrom: -0.7, panTo: 0.7, defaultVolume: 0.14 },
  { name: 'reorder', label: 'Reorder', category: 'movement', description: 'An item settles into a new position in a sequence.', duration: 0.34, baseMidi: 61, notes: [{ at: 0, semitone: 7, length: 0.1, glide: -2 }, { at: 0.085, semitone: 2, length: 0.1 }, { at: 0.17, semitone: 0, length: 0.13 }], noise: 0.08, transient: 0.38, defaultVolume: 0.18 },
  { name: 'invalid-drop', label: 'Invalid drop', category: 'movement', description: 'A dragged object cannot land in the current target.', duration: 0.4, baseMidi: 59, notes: [{ at: 0, semitone: 1, length: 0.11 }, { at: 0.12, semitone: -4, length: 0.13 }, { at: 0.24, semitone: 1, length: 0.11, glide: -2, gain: 0.65 }], noise: 0.14, transient: 0.3, defaultVolume: 0.19 },
  ...
  { name: 'receive', label: 'Receive', category: 'communication', description: 'A response or object arrives.', duration: 0.47, baseMidi: 72, notes: [{ at: 0, semitone: 12, length: 0.12, gain: 0.42 }, { at: 0.11, semitone: 4, length: 0.2, glide: -2 }, { at: 0.25, semitone: 0, length: 0.17, gain: 0.62 }], noise: 0.06, panFrom: 0.45, panTo: 0, defaultVolume: 0.2 },
  ...
  { name: 'typing', label: 'Typing', category: 'communication', description: 'A brief key contact during text entry.', duration: 0.045, baseMidi: 73, notes: [{ at: 0, semitone: 0, length: 0.024, glide: -1 }], noise: 0.025, transient: 0.18, defaultVolume: 0.065 },
  { name: 'reaction', label: 'Reaction', category: 'communication', description: 'A lightweight social response is added.', duration: 0.4, baseMidi: 75, notes: [{ at: 0, semitone: 0, length: 0.1 }, { at: 0.075, semitone: 12, length: 0.13, gain: 0.62 }, { at: 0.18, semitone: 7, length: 0.16 }], transient: 0.16, defaultVolume: 0.17 },
  ...
  { name: 'info', label: 'Info', category: 'feedback', description: 'A neutral system fact is surfaced.', duration: 0.46, baseMidi: 70, notes: [{ at: 0, semitone: 0, length: 0.18 }, { at: 0.2, semitone: 5, length: 0.18, gain: 0.58 }], defaultVolume: 0.16 },
  { name: 'blocked', label: 'Blocked', category: 'feedback', description: 'An action cannot continue in the current state.', duration: 0.43, baseMidi: 57, notes: [{ at: 0, semitone: -5, length: 0.13 }, { at: 0.14, semitone: -5, length: 0.2, glide: -2 }], noise: 0.12, transient: 0.44, defaultVolume: 0.2 },
  ...
  { name: 'start', label: 'Start', category: 'progress', description: 'A process, recording, or session begins.', duration: 0.46, baseMidi: 60, notes: [{ at: 0, semitone: -5, length: 0.12, gain: 0.48 }, { at: 0.1, semitone: 0, length: 0.18 }, { at: 0.24, semitone: 7, length: 0.18 }], noise: 0.04, defaultVolume: 0.19 },
  { name: 'stop', label: 'Stop', category: 'progress', description: 'A process, recording, or session ends.', duration: 0.4, baseMidi: 60, notes: [{ at: 0, semitone: 7, length: 0.11 }, { at: 0.1, semitone: 2, length: 0.12 }, { at: 0.2, semitone: -5, length: 0.15, gain: 0.72 }], noise: 0.06, defaultVolume: 0.19 },
  { name: 'progress-step', label: 'Progress step', category: 'progress', description: 'A discrete step advances inside a longer process.', duration: 0.23, baseMidi: 72, notes: [{ at: 0, semitone: 0, length: 0.07 }, { at: 0.085, semitone: 3, length: 0.1, gain: 0.64 }], noise: 0.02, defaultVolume: 0.12 },
  { name: 'complete', label: 'Complete', category: 'progress', description: 'A multi-step process reaches its final state.', duration: 0.8, baseMidi: 65, notes: [{ at: 0, semitone: 0, length: 0.22 }, { at: 0.22, semitone: 7, length: 0.25 }, { at: 0.46, semitone: 12, length: 0.27 }], defaultVolume: 0.24 },
  ...
  { name: 'loading', label: 'Loading', category: 'loops', description: 'A quiet repeating pulse while an interface fetches or waits.', duration: 1.2, baseMidi: 72, notes: [{ at: 0, semitone: 0, length: 0.16 }, { at: 0.3, semitone: 5, length: 0.16 }, { at: 0.6, semitone: 2, length: 0.16 }, { at: 0.9, semitone: 7, length: 0.16 }], loop: true, defaultVolume: 0.1 },
  { name: 'processing', label: 'Processing', category: 'loops', description: 'A restrained repeating bed while sustained work is running.', duration: 1.6, baseMidi: 62, notes: [{ at: 0, semitone: 0, length: 0.24 }, { at: 0.4, semitone: 5, length: 0.2, gain: 0.7 }, { at: 0.8, semitone: 2, length: 0.24 }, { at: 1.2, semitone: 7, length: 0.2, gain: 0.7 }], loop: true, noise: 0.05, defaultVolume: 0.08 },
  { name: 'recording', label: 'Recording', category: 'loops', description: 'A calm periodic pulse while audio or video capture is live.', duration: 1.0, baseMidi: 67, notes: [{ at: 0, semitone: 0, length: 0.2 }, { at: 0.5, semitone: 0, length: 0.14, gain: 0.45 }], loop: true, transient: 0.08, defaultVolume: 0.09 },
  { name: 'connecting', label: 'Connecting', category: 'loops', description: 'A repeating search pattern while a device or live session connects.', duration: 1.5, baseMidi: 69, notes: [{ at: 0, semitone: 0, length: 0.18 }, { at: 0.375, semitone: 4, length: 0.18 }, { at: 0.75, semitone: 7, length: 0.2 }, { at: 1.125, semitone: 4, length: 0.16, gain: 0.55 }], loop: true, panFrom: -0.3, panTo: 0.3, defaultVolume: 0.09 },
  { name: 'scanning', label: 'Scanning', category: 'loops', description: 'A spatial sweep repeats while content or devices are discovered.', duration: 1.4, baseMidi: 72, notes: [{ at: 0, semitone: -5, length: 0.28, glide: 8, gain: 0.55 }, { at: 0.7, semitone: 3, length: 0.28, glide: -8, gain: 0.45 }], loop: true, noise: 0.12, panFrom: -0.65, panTo: 0.65, defaultVolume: 0.075 },
  ...
  { name: 'play', label: 'Play', category: 'media', description: 'Media playback begins or resumes.', duration: 0.34, baseMidi: 67, notes: [{ at: 0, semitone: -5, length: 0.09, gain: 0.52 }, { at: 0.075, semitone: 0, length: 0.11 }, { at: 0.16, semitone: 7, length: 0.13, gain: 0.72 }], transient: 0.2, defaultVolume: 0.18 },
  ...
  { name: 'seek', label: 'Seek', category: 'media', description: 'The playback position moves to a new point.', duration: 0.3, baseMidi: 72, notes: [{ at: 0, semitone: -5, length: 0.105, glide: 2, gain: 0.55 }, { at: 0.115, semitone: 5, length: 0.12, glide: 2, gain: 0.72 }], noise: 0.15, panFrom: -0.55, panTo: 0.55, defaultVolume: 0.13 },
  { name: 'volume-change', label: 'Volume change', category: 'media', description: 'Playback loudness moves to a new level.', duration: 0.24, baseMidi: 76, notes: [{ at: 0, semitone: -4, length: 0.055, gain: 0.45 }, { at: 0.055, semitone: 0, length: 0.065, gain: 0.62 }, { at: 0.115, semitone: 4, length: 0.08 }], noise: 0.02, defaultVolume: 0.11 },
  { name: 'skip-next', label: 'Skip next', category: 'media', description: 'Playback advances to the next item.', duration: 0.29, baseMidi: 70, notes: [{ at: 0, semitone: 0, length: 0.075, gain: 0.58 }, { at: 0.07, semitone: 4, length: 0.085 }, { at: 0.145, semitone: 12, length: 0.105, gain: 0.78 }], panFrom: -0.35, panTo: 0.55, defaultVolume: 0.16 },
  { name: 'skip-previous', label: 'Skip previous', category: 'media', description: 'Playback returns to the previous item.', duration: 0.29, baseMidi: 70, notes: [{ at: 0, semitone: 12, length: 0.075, gain: 0.78 }, { at: 0.07, semitone: 4, length: 0.085 }, { at: 0.145, semitone: 0, length: 0.105, gain: 0.58 }], panFrom: 0.55, panTo: -0.35, defaultVolume: 0.16 },

  { name: 'connect', label: 'Connect', category: 'system', description: 'A device, service, or live session becomes available.', duration: 0.62, baseMidi: 64, notes: [{ at: 0, semitone: 0, length: 0.22 }, { at: 0.18, semitone: 5, length: 0.23 }, { at: 0.37, semitone: 12, length: 0.18, gain: 0.55 }], defaultVolume: 0.2 },
  ...
  { name: 'unlock', label: 'Unlock', category: 'system', description: 'Access opens or a protected state disengages.', duration: 0.45, baseMidi: 62, notes: [{ at: 0, semitone: -2, length: 0.1 }, { at: 0.095, semitone: 5, length: 0.14 }, { at: 0.21, semitone: 12, length: 0.18, glide: 2 }], transient: 0.3, defaultVolume: 0.2 },
  ...
  { name: 'badge', label: 'Badge', category: 'reward', description: 'A collectible distinction is awarded.', duration: 0.8, baseMidi: 71, notes: [{ at: 0, semitone: 0, length: 0.19 }, { at: 0.14, semitone: 9, length: 0.23 }, { at: 0.33, semitone: 16, length: 0.35 }], transient: 0.2, defaultVolume: 0.22 },
  ...
  { name: 'add-to-cart', label: 'Add to cart', category: 'commerce', description: 'An item enters a cart or pending order.', duration: 0.49, baseMidi: 70, notes: [{ at: 0, semitone: -2, length: 0.1, gain: 0.52 }, { at: 0.105, semitone: 7, length: 0.18 }, { at: 0.26, semitone: 2, length: 0.17, gain: 0.58 }], transient: 0.28, defaultVolume: 0.19 },
  { name: 'remove-from-cart', label: 'Remove from cart', category: 'commerce', description: 'An item leaves a cart or pending order.', duration: 0.45, baseMidi: 70, notes: [{ at: 0, semitone: 10, length: 0.1, gain: 0.55 }, { at: 0.1, semitone: 3, length: 0.14 }, { at: 0.22, semitone: -2, length: 0.16, gain: 0.64 }], transient: 0.22, defaultVolume: 0.17 },
...
export const PACKS = [
  ...
  { name: 'scifi', label: 'Sci-fi', description: 'Clean holographic pings with a restrained digital shimmer.', bestFor: 'AI tools, spatial UI, futuristic games', color: '#20a29d', waveform: 'sine', pitch: 1.1, duration: 0.84, attack: 0.0025, decay: 2.05, noise: 0.025, transient: 0.16, brightness: 0.82, echo: 0.035, bitDepth: 16, harmonics: [[1, 1], [2.01, 0.11], [3.98, 0.025]], fmRatio: 2.01, fmDepth: 0.42 },
  ...
  { name: 'zen', label: 'Zen', description: 'Pure tones, dry wood, and brief washi detail.', bestFor: 'Mindfulness, reading, writing, calm productivity', color: '#7d8f77', waveform: 'sine', pitch: 0.94, duration: 0.82, attack: 0.003, decay: 2.7, noise: 0, transient: 0.025, brightness: 0.52, echo: 0, bitDepth: 16, harmonics: [[1, 1], [2.01, 0.035]], paper: 0.12, brush: 0.065, wood: 0.16, chime: 0.09 },
