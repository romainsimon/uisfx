...
- The opaque 1200×630 JPEG social card uses a thumbnail-first composition, explicit dimensions and alt text, and a versioned filename so social crawlers cannot reuse a superseded image.
